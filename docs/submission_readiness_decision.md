...
Honest strongest claim: `Treat unobserved contact alternatives as first-class latent futures, not data augmentation.` is a plausible branch-structured mechanism for world-action models for contact-rich manipulation, supported by synthetic multi-seed diagnostic evidence and hostile-prior-work-aware positioning.
