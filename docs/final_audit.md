...
1. Chosen thesis: WAM Contact Counterfactuals explores `Treat unobserved contact alternatives as first-class latent futures, not data augmentation.` for world-action models for contact-rich manipulation.
...
8. Exact Downloads PDF path: `C:/Users/wangz/Downloads/61.pdf`
9. GitHub URL: https://github.com/Jason-Wang313/61_wam_contact_counterfactuals
