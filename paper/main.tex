...
\usepackage{url}
\usepackage{booktabs}
\title{WAM Contact Counterfactuals: ICLR Main-Conference Gate Archive}
\author{Anonymous Authors}
\begin{document}
\maketitle
\begin{abstract}
This document is not an ICLR main-conference submission. It is the v3 main-conference gate for a generated robotics draft about world-action models for contact-rich manipulation. The original research bet was: Treat unobserved contact alternatives as first-class latent futures, not data augmentation. After a stricter hostile review, the honest terminal decision is \textbf{KILL/ARCHIVE}. Submission-hardening version: v3.
\end{abstract}
...
\begin{itemize}
\item Data-Efficient and Contact-Rich Manipulation Through Diffusion Augmentation and Vision-Language Models (2026)
\item OmniVTA: Visuo-Tactile World Modeling for Contact-Rich Robotic Manipulation (2026)
\item Learning to Feel the Future: DreamTacVLA for Contact-Rich Manipulation (2025)
\item ForceVLA: Enhancing VLA Models with a Force-aware MoE for Contact-rich Manipulation (2025)
\item DexViTac: Collecting Human Visuo-Tactile-Kinematic Demonstrations for Contact-Rich Dexterous Manipulation (2026)
\end{itemize}
