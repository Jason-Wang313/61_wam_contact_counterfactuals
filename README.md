...
This repository contains a hardened, honest workshop-only robotics paper draft for `wam_contact_counterfactuals`.
...
Canonical local PDF path: `C:/Users/wangz/Downloads/61.pdf`
